...
kmeans = KMeans(n_clusters = clus, random_state = 0, n_init= 20, init = "k-means++")
...
numsum = 1000000 # the number of random numbers
for i in range(numsum):
    # a = randfloat(num = 128, l = 0, h = 127)
    a = np.random.randint(low = 0, high = 128, size = (1, 128), dtype='int')
    a = a.astype(float)
    min1 = 10000000.1
    min2 = 10000000.1
    idx1 = clus
